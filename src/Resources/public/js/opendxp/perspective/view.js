...
opendxp.registerNS('opendxp.bundle.perspectiveeditor.ViewEditor');

opendxp.bundle.perspectiveeditor.ViewEditor = class {
        ...
        if (!this.panel) {
            ...
            if(!readOnly) {
                toolbarButtons.push(new Ext.Button({
                    text: t('plugin_opendxp_perspectiveeditor_add_view'),
                    iconCls: "opendxp_icon_plus",
                    disabled: !opendxp.settings['custom-views-writeable'],
                    handler: function () {
                        Ext.MessageBox.prompt(t('plugin_opendxp_perspectiveeditor_new_view'), t('plugin_opendxp_perspectiveeditor_new_view'), function (button, value) {
                            ...
                            if (button === 'ok' && value.length > 0) {
                                const record = this.viewTreeStore.getRoot().appendChild({
                                    ...
                                    text: value,
                                    type: 'view',
                                    icon: '/bundles/opendxpadmin/img/flat-color-icons/view_details.svg',
                                    leaf: true,
                                    cls: 'plugin_opendxp_perspective_editor_custom_view_tree_item',
                                    writeable: true,
                                    config: {
                                        name: value,
                                        treetype: 'document',
                                ...
                                opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.reloadTreeNode(this.viewTreeStore.getRoot().lastChild);
                            }
                        }.bind(this))
                    }.bind(this)
                }));
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response){
                                ...
                                if(responseObject.success){
                                    ...
                                    opendxp.helpers.showNotification(t("error"), responseObject.error, "error")
                                }
                            }.bind(this)
                        });
                    }.bind(this)
            ...
            this.panel = new Ext.Panel({
                title: t("plugin_opendxp_perspectiveeditor_view_editor"),
                                            ...
                                            Ext.menu.Item({
                                                ...
                                                handler: function(){
                                                    if(record.data['writeable']) {
                                                        Ext.MessageBox.show({
                                                            title: t('plugin_opendxp_perspectiveeditor_are_you_sure'),
                                                            msg: t('plugin_opendxp_perspectiveeditor_all_content_will_be_lost'),
                                                            buttons: Ext.Msg.OKCANCEL,
                                                            icon: Ext.MessageBox.INFO,
                                                            fn: function (button) {
                                                                if (button === 'ok') {
    ...
    buildViewEditorPanel (record){
        if(record.data.type === 'view'){
            ...
            items.push(new Ext.form.FieldSet({
                title: t('plugin_opendxp_perspectiveeditor_name'),
            ...
            items.push(Ext.create('Ext.form.FieldSet', {
                title: t('plugin_opendxp_perspectiveeditor_view_default_positioning'),
                items: this.createDefaultPositionPart(record)
            }));

            this.viewEditPanel.add(
                new Ext.form.Panel({
                    title: t('plugin_opendxp_perspectiveeditor_view_selection'),
                    iconCls: 'opendxp_icon_custom_views',
                    disabled: !record.data["writeable"],
                    items: items
                })
    ...
    createViewNamingPart (record){
        ...
        var iconFormPanel = opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.createIconFormPanel(record, opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateUuid(), true);
        ...
        return [
            new Ext.form.TextField({
                fieldLabel: t('plugin_opendxp_perspectiveeditor_name'),
            ...
            new Ext.form.ComboBox({
                store: viewTypStore,
                fieldLabel: t('plugin_opendxp_perspectiveeditor_type'),
                displayField: 'name',
                valueField: 'value',
                editable: false,
            ...
            }),
            {
                ...
                layout: 'hbox',
                fieldLabel: t('plugin_opendxp_perspectiveeditor_icon'),
                items: iconItems,
            },
            new Ext.form.TextField({
                fieldLabel: t('plugin_opendxp_perspectiveeditor_rootfolder'),
                    ...
                    render: function (el) {
                        new Ext.dd.DropZone(el.getEl(), {
                            ...
                            onNodeDrop : function (target, dd, e, dragItemData) {
                                if(!opendxp.helpers.dragAndDropValidateSingleItem(dragItemData)) {
                                    return false;
                                }
            ...
            new Ext.form.ComboBox({
                fieldLabel: t('plugin_opendxp_perspectiveeditor_show_root'),
                displayField: 'name',
                valueField: 'show',
                editable: false,
                readOnly: this.readOnly,
            ...
            new Ext.ux.form.MultiSelect({
                store: classesStore,
                fieldLabel: t("plugin_opendxp_perspectiveeditor_allowed_classes") + '<br />' + t('plugin_opendxp_perspectiveeditor_allowed_types_hint'),
                name: 'classes',
                displayField: 'text',
                valueField: 'id',
    ...
    createDefaultPositionPart (record) {
        ...
        return [
            new Ext.form.NumberField({
                fieldLabel: t('plugin_opendxp_perspectiveeditor_sort'),
            ...
            new Ext.form.ComboBox({
                fieldLabel: t('plugin_opendxp_perspectiveeditor_position'),
                displayField: 'name',
                valueField: 'position',
                name: 'position',
                editable: false,
    ...
    createSqlPart (record){
        return new Ext.form.FieldSet({
            title: t('plugin_opendxp_perspectiveeditor_sql'),
            margin: '30 0',
            items: [
                new Ext.form.TextArea({
                    fieldLabel: t('plugin_opendxp_perspectiveeditor_sql_having'),
                ...
                new Ext.form.TextArea({
                    fieldLabel: t('plugin_opendxp_perspectiveeditor_sql_where'),
    ...
    createViewContextMenuPart (data){
        ...
        opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateCheckboxesForStructure(config.treeContextMenu.document, documentContextMenuItems, this.setDirty.bind(this, true), 'plugin_opendxp_perspectiveeditor_document', this.readOnly);
        ...
        opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateCheckboxesForStructure(config.treeContextMenu.asset, assetContextMenuItems, this.setDirty.bind(this, true), 'plugin_opendxp_perspectiveeditor_asset', this.readOnly);
        ...
        opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateCheckboxesForStructure(config.treeContextMenu.object, objectContextMenuItems, this.setDirty.bind(this, true), 'plugin_opendxp_perspectiveeditor_object', this.readOnly);
    ...
    setDirty(dirty) {
        if(this.dirty !== dirty) {
            ...
            if(dirty) {
                this.panel.setTitle(t("plugin_opendxp_perspectiveeditor_view_editor") + ' *');
            } else {
                this.panel.setTitle(t("plugin_opendxp_perspectiveeditor_view_editor"));
            }
        }
