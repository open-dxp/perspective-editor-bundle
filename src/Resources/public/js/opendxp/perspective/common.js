...
opendxp.registerNS('opendxp.bundle.perspectiveeditor.PerspectiveViewHelper');

opendxp.bundle.perspectiveeditor.PerspectiveViewHelper = class {
    ...
    static createIconFormPanel (record, id, applyToRecord, changeCallback){
        ...
        return new Ext.form.Panel({
            ...
            title: t('plugin_opendxp_perspectiveeditor_icon_selection'),
            ...
            items: [
                ...
                new Ext.Button({
                    ...
                    margin: '10 0 0',
                    handler: function () {
                        opendxp.helpers.openGenericIframeWindow("icon-library", Routing.generate('opendxp_admin_misc_iconlist'), "opendxp_icon_icons", t("icon_library"));
                    },
                }),
            ],
        });
