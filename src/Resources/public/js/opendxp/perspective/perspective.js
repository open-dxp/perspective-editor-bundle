...
opendxp.registerNS('opendxp.bundle.perspectiveeditor.PerspectiveEditor');

opendxp.bundle.perspectiveeditor.PerspectiveEditor = class {

    routePrefix = '/admin/perspectives-views/perspective';
    availablePortlets = [
        {name: t('modificationStatistic'), value: 'opendxp.layout.portlets.modificationStatistic'},
        {name: t('modifiedDocuments'), value: 'opendxp.layout.portlets.modifiedDocuments'},
        {name: t('modifiedAssets'), value: 'opendxp.layout.portlets.modifiedAssets'},
        {name: t('modifiedObjects'), value: 'opendxp.layout.portlets.modifiedObjects'},
        {name: t('analytics'), value: 'opendxp.layout.portlets.analytics'},
        {name: t('customreports'), value: 'opendxp.layout.portlets.customreports'}
    ];
    activeRecordId = null;
    deletedRecords = [];
    ...
    constructor () {
        ...
        if (!this.panel) {
            ...
            this.panel = new Ext.Panel({
                title: t('plugin_opendxp_perspectiveeditor_perspective_editor'),
                iconCls: 'plugin_opendxp_perspective_editor_perspective',
                border: false,
                layout: 'border',
                items: [
                    new Ext.tree.Panel({
                        ...
                        tbar: {
                            ...
                            items: [
                                new Ext.Button({
                                    text: t("plugin_opendxp_perspectiveeditor_add_perspective"),
                                    iconCls: "opendxp_icon_plus",
                                    disabled: !opendxp.settings['perspectives-writeable'],
                                    handler: function(){
                                        Ext.MessageBox.prompt(t('plugin_opendxp_perspectiveeditor_new_perspective'), t('plugin_opendxp_perspectiveeditor_new_perspective'), function (button, value) {
                                            ...
                                            if (button === 'ok' && value.length > 0) {
                                                ...
                                                this.perspectiveTreeStore.getRoot().appendChild({
                                                    id: opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateUuid(),
                                                    text: value,
                                                    name: value,
                                                    type: 'perspective',
                                                    ...
                                                    children: [
                                                        {
                                                            id: opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateUuid(),
                                                            text: t('plugin_opendxp_perspectiveeditor_icon'),
                                                            type: 'icon',
                                                            leaf: true,
                                                        ...
                                                        {
                                                            id: opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateUuid(),
                                                            text: t('plugin_opendxp_perspectiveeditor_elementTreeLeft'),
                                                            type: 'elementTree',
                                                            leaf: false,
                                                            expanded: true,
                                                            children: [],
                                                            ...
                                                            id: opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateUuid(),
                                                            text: t('plugin_opendxp_perspectiveeditor_elementTreeRight'),
                                                        ...
                                                        {
                                                            id: opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateUuid(),
                                                            text: t('plugin_opendxp_perspectiveeditor_dashboard'),
                                                            type: 'dashboard',
                                                            leaf: true,
                                                        ...
                                                        {
                                                            id: opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateUuid(),
                                                            text: t('plugin_opendxp_perspectiveeditor_toolbar'),
                                                            type: 'toolbar',
                                                            leaf: true,
                                                ...
                                                this.setDirty(true);
                                                opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.reloadTreeNode(this.perspectiveTreeStore.getRoot().lastChild);
                                            }
                                        }.bind(this))
                                    }.bind(this)
                                }),
                ...
                buttons: [
                        "->",
                        new Ext.Button({
                            text: t("plugin_opendxp_perspectiveeditor_reload"),
                            iconCls: "opendxp_icon_reload",
                            handler: function () {
                                Ext.MessageBox.show({
                                    title: t('plugin_opendxp_perspectiveeditor_are_you_sure'),
                                    msg: t('plugin_opendxp_perspectiveeditor_confirm_reload'),
                                ...
                                Ext.Ajax.request({
                                    ...
                                    method: 'POST', success: function (response) {
                                        ...
                                        if (responseObject.success) {
                                            ...
                                            opendxp.helpers.showNotification(t("error"), t(responseObject.error), "error");
                                        }
                                    }.bind(this)
                                });
                            }.bind(this)
    ...
    setAvailablePortlets (){
        ...
        for (var i = 0; i < portlets.length; i++) {
            ...
            if (portletType != "abstract") {
                portletMenu.push({
                    name: opendxp.layout.portlets[portletType].prototype.getName(),
                    value: 'opendxp.layout.portlets.' + portletType
                });
            }
        }
    ...
    buildRenameDialog (record){
        return Ext.menu.Item({
            text: t('plugin_opendxp_perspectiveeditor_rename'),
            iconCls: 'opendxp_icon_edit',
            disabled: !record.data["writeable"],
            handler: function(){
                if(record.data["writeable"] === true) {
                    Ext.MessageBox.prompt(t('plugin_opendxp_perspectiveeditor_rename'), t('plugin_opendxp_perspectiveeditor_perspective_rename'), function (button, value) {
                        value = this.sanitizeName(value);
                        if (button === 'ok' && value !== record.data.text) {
                            ...
                            opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.reloadTreeNode(record);
                            this.setDirty(true);
                        }
    ...
    buildAddDialog (record, tree){
        return Ext.menu.Item({
            text: t('plugin_opendxp_perspectiveeditor_add'),
    ...
    addDashboard (parent, tree) {
        ...
        const record = parent.appendChild({
            text: t('plugin_opendxp_perspectiveeditor_new_dashboard_definition'),
        ...
        return Ext.menu.Item({
            ...
            handler: function(){
                if(record.data["writeable"] === true) {
                    Ext.MessageBox.show({
                        title: t('plugin_opendxp_perspectiveeditor_are_you_sure'),
                        msg: t('plugin_opendxp_perspectiveeditor_confirm_delete'),
                        buttons: Ext.Msg.OKCANCEL,
                        icon: Ext.MessageBox.INFO,
                        fn: function (button) {
                            if (button === 'ok') {
    ...
    buildPerspectiveEditorPanel (record){
        ...
        switch(record.data.type){
            case 'icon': this.perspectiveEditPanel.add(opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.createIconFormPanel(record, opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateUuid(), false, this.setDirty.bind(this, true))); break;
    ...
    createToolbarFormPanel (record){
        ...
        let additionalStructures = opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadStructureForPermissions('toolbar');
        var structure = {
            file: opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('toolbar', 'file'),
            marketing: opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('toolbar', 'marketing'),
            extras: opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('toolbar', 'extras'),
            settings: opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('toolbar', 'settings'),
            search: opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('toolbar', 'search'),
        };
        Object.entries(additionalStructures).forEach((kvp) => {
            let key = kvp[0];
            structure[key] = opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('toolbar', key);
        });

        opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.checkAndCreateDataStructure(config, structure);
        ...
        Object.entries(config).forEach((kvp) => {
            ...
            let key = kvp[0];
            let value = kvp[1];
            opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateCheckboxesForStructure(value, menuItems, this.setDirty.bind(this, true), 'plugin_opendxp_perspectiveeditor_menu_' + key);

            fieldSetItems.push(new Ext.form.FieldSet({
                title: t('plugin_opendxp_perspectiveeditor_' + key),
                collapsible: true,
                items: menuItems
            }));
        });
        ...
        return new Ext.Panel({
            title: t('plugin_opendxp_perspectiveeditor_toolbar_access'),
            iconCls: 'opendxp_icon_support',
            disabled: !record.data["writeable"],
            items: [
                new Ext.Panel({
                    width: '50%',
    ...
    createDashboardDefinitionFormPanel (record){
        ...
        selectablePortlets.unshift({name: t('plugin_opendxp_perspectiveeditor_select_empty'), value: emptyValue});
        ...
        return new Ext.form.Panel({
            disabled: !record.data["writeable"],
            title: t('plugin_opendxp_perspectiveeditor_dashboard_assignment'),
            items: [
                new Ext.grid.Panel({
                    selType: 'cellmodel',
                    clicksToEdit: 1,
                    ...
                    columns: [
                        {
                            text: t('plugin_opendxp_perspectiveeditor_left_column'),
                            width: '50%',
                            sortable: false,
                            hideable: false,
                            dataIndex: 'left',
                        ...
                        {
                            text: t('plugin_opendxp_perspectiveeditor_right_column'),
                            width: '50%',
                            sortable: false,
                            hideable: false,
                            dataIndex: 'right',
    ...
    buildDashboardContextMenuItems (record, index, gridData){
        ...
        return [
            ...
            Ext.menu.Item({
                text: t('plugin_opendxp_perspectiveeditor_remove'),
                iconCls: 'opendxp_icon_delete',
                handler: function(){
                    Ext.MessageBox.show({
                        title:t('plugin_opendxp_perspectiveeditor_are_you_sure'),
    ...
    createDashboardFormPanel (record){
        ...
        return new Ext.form.Panel({
            disabled: !record.data["writeable"],
            title: t('plugin_opendxp_perspectiveeditor_dashboard_forbidden'),
            items: items
        });
    }
    ...
    createElementTreePanel (record){
        ...
        const elementTreeTypeStore = new Ext.data.Store({
            ...
            data: [
                {name: t('plugin_opendxp_perspectiveeditor_document'), value: 'documents'},
                {name: t('plugin_opendxp_perspectiveeditor_asset'), value: 'assets'},
                {name: t('plugin_opendxp_perspectiveeditor_object'), value: 'objects'},
                {name: t('plugin_opendxp_perspectiveeditor_custom_view'), value: 'customview'}
            ]
        });
        const postCreatePerspectiveEditorElementTreeTypeStore = new CustomEvent(opendxp.events.postCreatePerspectiveEditorElementTreeTypeStore, {
            detail: {
        ...
        var customViewComboBox = new Ext.form.ComboBox({
            ...
            padding: 10,
            width: '75%',
            fieldLabel: t('plugin_opendxp_perspectiveeditor_custom_view'),
            queryMode: 'local',
        ...
        const structure = {
            document: opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('customViewContextMenu', 'document'),
            asset: opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('customViewContextMenu', 'asset'),
            object: opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper.loadPermissions('customViewContextMenu', 'object')
        };

        opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.checkAndCreateDataStructure(config.treeContextMenu, structure);

        let documentContextMenuItems = [];
        opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateCheckboxesForStructure(config.treeContextMenu.document, documentContextMenuItems, this.setDirty.bind(this, true), 'plugin_opendxp_perspectiveeditor_document');


        var documentTreeContextMenuGroup = new Ext.form.FieldSet({
            name: 'perspective_editor_documents',
            title: t('plugin_opendxp_perspectiveeditor_document') + ' - ' + t('plugin_opendxp_perspectiveeditor_contextmenu'),
        ...
        opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateCheckboxesForStructure(config.treeContextMenu.asset, assetContextMenuItems, this.setDirty.bind(this, true), 'plugin_opendxp_perspectiveeditor_asset');

        var assetTreeContextMenuGroup = new Ext.form.FieldSet({
            name: 'perspective_editor_assets',
            title: t('plugin_opendxp_perspectiveeditor_asset') + ' - ' + t('plugin_opendxp_perspectiveeditor_contextmenu'),
        ...
        opendxp.bundle.perspectiveeditor.PerspectiveViewHelper.generateCheckboxesForStructure(config.treeContextMenu.object, objectContextMenuItems, this.setDirty.bind(this, true), 'plugin_opendxp_perspectiveeditor_object');

        var objectTreeContextMenuGroup = new Ext.form.FieldSet({
            name: 'perspective_editor_objects',
            title: t('plugin_opendxp_perspectiveeditor_object') + ' - ' + t('plugin_opendxp_perspectiveeditor_contextmenu'),
        ...
        const addPerspectiveEditorElementTreeIcon = new CustomEvent(opendxp.events.addPerspectiveEditorElementTreeIcon);
        ...
        const elementTreeSettingsForm = new Ext.form.Panel({
            ...
            title: t('plugin_opendxp_perspectiveeditor_tree_element_selection'),
            icon: '/bundles/opendxpadmin/img/flat-color-icons/genealogy.svg',
            items: [
                new Ext.form.ComboBox({
                    padding: 10,
                    fieldLabel: t('plugin_opendxp_perspectiveeditor_view_type'),
                    queryMode: 'local',
                ...
                new Ext.form.Checkbox({
                    boxLabel: t('plugin_opendxp_perspectiveeditor_view_expanded'),
                    padding: "10 10 0",
                ...
                new Ext.form.Checkbox({
                    boxLabel: t('plugin_opendxp_perspectiveeditor_view_hidden'),
        ...
        const preAddElementTreeSettingsForm = new CustomEvent(opendxp.events.preAddPerspectiveEditorElementTreeSettingsForm, {
            detail: {
                record: record,
    ...
    setDirty(dirty) {
        if(this.dirty !== dirty) {
            ...
            if(dirty) {
                this.panel.setTitle(t("plugin_opendxp_perspectiveeditor_perspective_editor") + ' *');
            } else {
                this.panel.setTitle(t("plugin_opendxp_perspectiveeditor_perspective_editor"));
            }
        }
