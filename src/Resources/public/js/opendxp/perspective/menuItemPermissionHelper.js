...
opendxp.registerNS('opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper');

opendxp.bundle.perspectiveeditor.MenuItemPermissionHelper = class {
    ...
    static loadPermissions(context, menu) {
        ...
        const onPerspectiveEditorLoadPermissions = new CustomEvent(opendxp.events.onPerspectiveEditorLoadPermissions, {
            detail: {
                context: context,
                menu: menu,
    ...
    static loadStructureForPermissions(context) {
        ...
        const onPerspectiveEditorLoadStructureForPermissions = new CustomEvent(opendxp.events.onPerspectiveEditorLoadStructureForPermissions, {
            detail: {
                context: context,
                structure: structure
            }
